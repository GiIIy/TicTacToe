...
public class board {
    ...
    public static void reset(JButton a1, JButton a2, JButton a3, JButton b1, JButton b2, JButton b3, JButton c1, JButton c2, JButton c3) {
        a1.setText("");
        a2.setText("");
        a3.setText("");
        b1.setText("");
    ...
    public void setPlayer(JButton button) {
        if(button.getText().equals("")){
            if(go == true){
                button.setFont(new Font("Arial", Font.PLAIN, 40));a1.setFont(new Font("Arial", Font.PLAIN, 40));
    ...
    public static void checkWins(JButton a1, JButton a2, JButton a3, JButton b1, JButton b2, JButton b3, JButton c1, JButton c2, JButton c3) {
        if (a1.getText().equals(a2.getText()) && a2.getText().equals(a3.getText()) && !a1.getText().equals("")) {
            ...
            if(!a1.getText().equals("") && !a2.getText().equals("") && !a3.getText().equals("") && !b1.getText().equals("") && !b2.getText().equals("") && !b3.getText().equals("") && !c1.getText().equals("") && !c2.getText().equals("") && !c3.getText().equals("")){
